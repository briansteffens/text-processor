...
Remove.prototype = new TextProcessor();
Remove.prototype.constructor = Remove;

Remove.prototype.createOptionsData = function() {
    return {
        "fields": [
            {"name": "remove from side", "type": "enum",
             "enum_options": ["left", "right", "both"]
            },
            {"name": "string to remove", "type": "string"},
            {"name": "greedy", "type": "bool"},
        ],
    };
};

Remove.prototype.process = function(options, input) {
